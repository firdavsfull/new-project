      ...
      <div class="mx-[20px] mt-[10px] h-[auto]">
        ...
        <div class="quantity-room-container">
          ...
          <div class="quantity-room">
            <label class="quantity-room-item" for="1">
              <input
                :checked="apartmentParams.quantityRoom == 1"
                @change="quantityRoom"
                data-name="1"
                name="radioInput"
                type="radio"
              ...
              <span
                :style="
                  !apartmentParams.quantityRoom ? 'border:1px solid red;' : ''
                "
                class="form-control"
                >1</span
              >
            ...
            <label class="quantity-room-item" for="2">
              <input
                :checked="apartmentParams.quantityRoom == 2"
                @change="quantityRoom"
                data-name="2"
                name="radioInput"
                type="radio"
            ...
            <label class="quantity-room-item" for="3">
              <input
                :checked="apartmentParams.quantityRoom == 3"
                @change="quantityRoom"
                data-name="3"
                name="radioInput"
                type="radio"
            ...
            <label class="quantity-room-item" for="4">
              <input
                :checked="apartmentParams.quantityRoom == 4"
                @change="quantityRoom"
                data-name="4"
                name="radioInput"
                type="radio"
            ...
            <label class="quantity-room-item" for="5">
              <input
                :checked="apartmentParams.quantityRoom == 5"
                @change="quantityRoom"
                data-name="5"
                name="radioInput"
                type="radio"
          ...
          <div class="area-room">
            <div class="room">
              ...
              <div style="flex-direction: column" class="relative">
                <div
                  :style="
                    !apartmentParams.generalArea ? 'border:1px solid red;' : ''
                  "
                  class="input-area form-control"
                >
                  <input
                    @input="verfied"
                    v-model="apartmentParams.generalArea"
                    type="text"
                    v-maska
                    data-maska="####"
                  />
                ...
                <p
                  ...
                  v-if="mooreArea"
                  class="overflow-hidden whitespace-nowrap leading-[15px] text-[red] font-normal lg:relative md:relative md:left-0 absolute sm:relative sm:left-0 top-[4px] lg:left-0 left-[50%]"
                >
                  Общая площадь должна быть <br />больше жилой + кухни
                </p>
              </div>
            </div>
            ...
            <div class="room">
              ...
              <div
                :style="
                  !apartmentParams.liveArea ? 'border:1px solid red;' : ''
                "
                class="input-area form-control"
              >
                <input
                  @input="verfied"
                  v-model="apartmentParams.liveArea"
                  type="text"
                  v-maska
                  data-maska="####"
                />
        ...
        <div class="area-room-container mt-5">
          <div class="area-room">
            <div class="room">
              ...
              <div
                :style="
                  !apartmentParams.kitchenArea ? 'border:1px solid red;' : ''
                "
                class="input-area form-control"
              >
                <input
                  @input="verfied"
                  v-model="apartmentParams.kitchenArea"
                  type="text"
                  v-maska
                  data-maska="####"
                />
        ...
        <div class="container-input-link">
          <div style="flex-basis: 280px; margin-top: 16px">
            <label for="link-video"> Ссылка на Youtube </label>
            <textarea
              v-model="apartmentParams.linkvideo"
        ...
        <div class="container mt-4 mb-2 d-flex justify-content-end mx-1">
          <next-btn
            class="btn btn-light text-primary px-4 mx-4"
            @click.prevent="prew"
            >Назад</next-btn
          >
          <next-btn class="btn btn-primary px-4" @click.prevent="next"
            >Далее</next-btn
          >
        </div>
      </div>
