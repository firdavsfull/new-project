            ...
            <ul style="list-style: none;" class="m-[0] p-[0] w-full">
                ...
                <div class="flex m-0 p-0">
                    <div class="h-full m-[0] w-[200px]">
                        <img class="w-[200px] h-full" :src="`http://192.168.100.45:8000:8000/api/image/small/${announ.image}`">
                    </div>
...
onMounted(async()=>{
    await fetch('http://192.168.100.45:8000:8000/api/get_announs_by_user',{
        method:'post',
        headers:{
