...
async function addNewPicture(event){
    ...
    await fetch('http://192.168.100.45:8000:8000/api/avatar',{
        method:'post',
        headers:{
...
async function sendData(){
   await fetch('http://192.168.100.45:8000:8000/api/update_user',{
        method:'post',
        headers:{
...
async function sendMessage(){
    await fetch('http://192.168.100.45:8000:8000/api/send_message',{
        method:'post',
        headers:{
            "Content-Type":'application/json',
            Authorization:'Bearer '+JSON.parse(localStorage.getItem('owner'))[0] 
...
onMounted(async ()=>{
    await fetch('http://192.168.100.45:8000:8000/api/get_user',{
        method:'post',
        headers:{
            "Content-Type":'application/json',
            Authorization:'Bearer '+JSON.parse(localStorage.getItem('owner'))[0] 
